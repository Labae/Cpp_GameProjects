...
{
    FlashFx::FlashFx(int32_t screenWidth, int32_t screenHeight, const sf::Color& color, float duration, int count)
    ...
    void FlashFx::Render(IGraphics& graphics)
    {
        ...
        const auto finalAlpha = static_cast<uint8_t>(m_color.a * alpha);
